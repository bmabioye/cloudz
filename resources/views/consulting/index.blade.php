...
<div class="bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-200">
    ...
    <div class="relative bg-gradient-to-r from-blue-500 to-blue-700 text-white text-center py-16 px-4">
        ...
        <div class="flex justify-center space-x-4">
            <a href="javascript:void(0);" onclick="openQModal()" class="bg-white text-blue-700 px-6 py-3 rounded shadow font-medium hover:bg-gray-200">Get a Quote</a>
    ...
    <div class="max-w-7xl mx-auto py-12 px-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            @foreach([
                ...
                ['icon' => 'gavel', 'title' => 'GRC Services', 'desc' => 'Governance, risk, and compliance.'],
                ...
                ['icon' => 'building', 'title' => 'Industry-Specific Solutions', 'desc' => 'FinTech, retail, and more.'],
            ] as $service)
    ...
    <div class="bg-blue-500 text-white text-center py-8">
        ...
        <div class="mt-4">
            <a href="javascript:void(0);" onclick="openQModal()" class="bg-white text-blue-700 px-6 py-3 rounded shadow font-medium hover:bg-gray-200">Get Started</a>
